...
- `v1` - историческая эталонная реализация PARMONC
...
### 5. Запуск специального режима `model1_rng16`
...
- Этот пакет сознательно ориентирован на исходники. Готовые бинарные файлы в него не включены.
...
- В `scripts/extra/` лежат несколько более поздних вспомогательных сценариев, пригодившихся при реконструкции и сравнительных прогонах.
